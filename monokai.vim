...
" Javascript
call s:h("jsObjectColon",       { "fg": s:pink })
call s:h("jsGlobalObjects",     { "fg": s:white, "format": "bold" })
call s:h("jsDot",               { "fg": s:white })
call s:h("jsObjectSeparator",   { "fg": s:white })
call s:h("jsTemplateBraces",    { "fg": s:yellow })
call s:h("jsIfElseBraces",      { "fg": s:white, "format": "bold" })
call s:h("jsObjectBraces",      { "fg": s:white, "format": "bold" })
call s:h("jsFuncBraces",        { "fg": s:white, "format": "bold" })
call s:h("jsNoise",             { "fg": s:white })
call s:h("jsFuncName",          { "fg": s:green })
call s:h("jsParens",            { "fg": s:white, "format": "bold" })
call s:h("jsFuncParens",        { "fg": s:white, "format": "bold" })
call s:h("jsArrowFunction",     { "fg": s:pink })
call s:h("jsVariableDef",       { "fg": s:green })
call s:h("jsOperator",          { "fg": s:pink })
call s:h("jsThis",              { "fg": s:aqua })
...
call s:h("jsFuncArgs",          { "fg": s:green, "format": "italic" })
call s:h("jsStorageClass",      { "fg": s:aqua })
call s:h("jsDocTags",           { "fg": s:aqua,   "format": "italic" })
call s:h("jsReturn",            { "fg": s:aqua })
call s:h("jsExport",            { "fg": s:aqua })
call s:h("jsConditional",       { "fg": s:aqua })
call s:h("jsBooleanTrue",       { "fg": s:aqua })
call s:h("jsBooleanFalse",       { "fg": s:aqua })
call s:h("jsImport",            { "fg": s:aqua })
call s:h("jsFuncName",          { "fg": s:aqua })
call s:h("jsNoise",             { "fg": s:pink })
call s:h("jsClassBraces",       { "fg": s:white, "format": "bold" })
call s:h("jsBrackets",          { "fg": s:white, "format": "bold" })
call s:h("jsDestructuringBraces", { "fg": s:white, "format": "bold" })
call s:h("jsFuncName",          { "fg": s:green })
call s:h("jsFrom",              { "fg": s:green })
call s:h("jsfuncArgCommas",     { "fg": s:white, "format": "bold" })
call s:h("jsModuleComma",       { "fg": s:white, "format": "bold" })
call s:h("jsModuleBraces",      { "fg": s:white, "format": "bold" })
